...
const ClosedJobs = () => {
  ...
  useEffect(() => {
    const fetchJobs = async () => {
      try {
        setLoading(true);
        const response = await getInActiveJobPosted(userId);
  ...
  return (
    <MainLayout>
      ...
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">
            History of your previous job opportunities
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6 mb-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-4 sm:p-5 group hover:border-rose-100 transition-all duration-300">
          <div className="flex items-center justify-between mb-3">
            <div className="p-2 bg-rose-50 rounded-xl group-hover:bg-rose-600 transition-colors">
              <svg
                className="w-5 h-5 text-rose-600 group-hover:text-white"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <span className="text-[10px] font-black text-rose-600 uppercase tracking-widest bg-rose-50 px-2.5 py-1 rounded-full">
              Closed
            </span>
          </div>
          <p className="text-2xl font-black text-slate-900 leading-none">
              ...
              {jobs.length === 0 ? (
                ...
                jobs.map((job, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center">
                      <span className="px-2.5 py-1 text-[9px] font-black uppercase rounded-lg border bg-rose-50 text-rose-700 border-rose-100">
                        Closed
                      </span>
                    </td>
                    <td className="px-6 py-4">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="min-w-0">
                    <div className="flex items-center gap-2 mb-1.5">
                      ...
                      <span className="px-1.5 py-0.5 text-[9px] font-black uppercase rounded-lg border bg-rose-50 text-rose-700 border-rose-100">
                        Closed
                      </span>
                    </div>
